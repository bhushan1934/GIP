...
<head>
  ...
  <link href="{{ asset('asset/fontawesome-free/css/all.min.css') }}" rel="stylesheet">
  <link href="{{ asset('asset/aos/aos.css') }}" rel="stylesheet">
...
<body>
  ...
  <header id="header" class="header d-flex align-items-center">
    <div class="container-fluid container-xl d-flex align-items-center justify-content-between">
      ...
      <a href="index.html" class="logo d-flex align-items-center">
        ...
        <h1>Gurukrupa Infra<span>.</span></h1>
      </a>
  ...
  <section id="hero" class="hero">
      ...
      <div class="container">
        <div class="row justify-content-center">
          <div class="col-lg-6 text-center">
            <h2 data-aos="fade-down">Welcome to <span>Gurukrupa Infra Projects</span></h2>
    ...
    <div id="hero-carousel" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
        ...
        <div class="carousel-item" style="background-image: url('{{ asset('/img/build.jpg') }}')"></div>
                  ...
                  <div class="offer_detail">
                      ...
                      <div class="box-button">
                          <a href="#" class="banner-btn theme-btn" data-animation-in="bounceInLeft" data-animation-out="animate-out bounceOutRight">
                              <span class="btn-title">Write a review</span>
                              <span></span>
                              <span></span>
                              <span></span>
                              <span></span>
    ...
    <div class="footer-legal text-center position-relative">
      <div class="container">
        ...
        <div class="credits">
          ...
          Designed by <a href="https://bootstrapmade.com/">Bhushan Sonawane</a>
        </div>
      </div>
    </div>
  ...
  <script src="{{ asset('asset/glightbox/js/glightbox.min.js')}}"></script>
  <script src="{{ asset('asset/isotope-layout/isotope.pkgd.min.js')}}"></script>
  <script src="{{ asset('asset/swiper/swiper-bundle.min.js')}}"></script>
  <script src="{{ asset('asset/purecounter/purecounter_vanilla.js')}}"></script>
  <script src="{{ asset('asset/php-email-form/validate.js')}}"></script>
